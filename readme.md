...
Secure Coding 과제 요구사항(회원가입/로그인, 상품 등록/조회/관리, 전체 채팅 및 1:1 채팅,
신고 기반 악성 유저/상품 차단, 유저 간 송금, 상품 검색, 관리자 기능)을 모두 포함합니다.
...
- 유저 간 송금 (모의 잔액 시스템, 송금 시 비밀번호 재인증, DB 트랜잭션으로 원자성 보장)
